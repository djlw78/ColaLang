    ...
    public partial class Interpreter
    {
        ...
        public void RegisterFunctions()
        {
          ...
          //  ParserFunction.RegisterFunction(Constants.PUTS, new _Puts());
            ...
            ParserFunction.RegisterFunction(Constants.PRINTF, new PrintfFunction());
            ...
            ParserFunction.RegisterFunction(Constants.BEEP, new BeepFunction());
           ...
           // ParserFunction.RegisterFunction(Constants.STOP_DEBUGGER, new DebuggerFunction(false));
            ...
            ParserFunction.RegisterFunction(Constants.COLAEVAL, new CompileCSharp());

            //IMPORTANT COLA CONSOLE PLUGS REGISTOR
            ParserFunction.RegisterFunction(Constants.COLAWRITELINE, new PrintFunction());
            ParserFunction.RegisterFunction(Constants.COLAREADLINE, new ReadConsole());
            ParserFunction.RegisterFunction(Constants.COLAEGGBEEP, new EggBeepFunction());
            ...
            ParserFunction.RegisterFunction(Constants.GRAPHICS_LOADIMAGE, new GraphicsLoadImage());
            ParserFunction.RegisterFunction(Constants.GRAPHICS_DRAWIMAGE, new GraphicsDrawImage());
            ParserFunction.RegisterFunction(Constants.GRAPHICS_GETCLICK, new GraphicsGetMouseEvent());
