...
namespace ColaLang
{
    ...
    public class COLAClass : ParserFunction
    {
        public COLAClass() {}

        public COLAClass(string className)
        {
            Name = className;
            RegisterClass(className, this);
        }

        public COLAClass(string className, string[] baseClasses)
        {
            Name = className;
            RegisterClass(className, this);
            ...
            {
                var bc = COLAClass.GetClass(baseClass);
                if (bc == null)
                {
        ...
        public static void RegisterClass(string className, COLAClass obj)
        {
        ...
        public static COLAClass GetClass(string name)
        {
            ...
            COLAClass theClass = null;
            s_allClasses.TryGetValue(name, out theClass);
            return theClass;
        }

        static Dictionary<string, COLAClass> s_allClasses =
            new Dictionary<string, COLAClass>();
        ...
        public class ClassInstance : ScriptObject
        {
                                 ...
                                 ParsingScript script = null)
            {
                ...
                m_colaClass = COLAClass.GetClass(className);
                if (m_colaClass == null)
                {
                ...
                foreach (var entry in m_colaClass.m_classProperties)
                {
                ...
                if (m_colaClass.m_constructors.TryGetValue(args.Count, out constructor))
                {
            ...
            public override string ToString()
            {
                ...
                if (!m_colaClass.m_customFunctions.TryGetValue(Constants.PROP_TO_STRING.ToLower(),
                     out customFunction))
                {
                    return m_colaClass.Name + "." + InstanceName;
                }
            ...
            public async Task<Variable> GetProperty(string name, List<Variable> args = null, ParsingScript script = null)
            {
                ...
                if (!m_colaClass.m_customFunctions.TryGetValue(name, out CustomFunction customFunction))
                {
                    return null;
                }
                if (args == null)
            ...
            public List<string> GetProperties()
            {
                ...
                props.AddRange(m_colaClass.m_customFunctions.Keys);
    ...
    class NewObjectFunction : ParserFunction
    {
        public override Variable Evaluate(ParsingScript script)
        {
            ...
            CompiledClass csClass = COLAClass.GetClass(className) as CompiledClass;
            if (csClass != null)
            {
                ScriptObject obj = csClass.GetImplementation(args);
                return new Variable(obj);
            }
            CompiledClassAsync csClassAsync = COLAClass.GetClass(className) as CompiledClassAsync;
            ...
            COLAClass.ClassInstance instance = new
                COLAClass.ClassInstance(script.CurrentAssign, className, args, script);
    ...
    public class ClassCreator : ParserFunction
    {
        public override Variable Evaluate(ParsingScript script)
        {
            ...
            COLAClass newClass = new COLAClass(className, baseClasses);
    ...
    public class CustomFunction : ParserFunction
    {
        ...
        public Variable Run(List<Variable> args = null, ParsingScript script = null,
                            COLAClass.ClassInstance instance = null)
        {
        ...
        public ParsingScript m_parentScript = null;
        public int m_parentOffset = 0;
        public StackLevel m_stackLevel;
